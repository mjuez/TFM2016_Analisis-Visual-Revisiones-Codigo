...
\newenvironment{pcr}{\fontfamily{pcr}\selectfont}{\par}
\DeclareTextFontCommand{\textcourier}{\pcr}
...
\newcommand{\nombre}{Mario Juez Gil} %%% cambio de comando

% Datos de portada
\title{Análisis Visual de Revisiones de Código}
\author{\nombre}
\tutor{Dr. Carlos López Nozal, Dr. Raúl Marticorena Sánchez}
\date{\today}
...
\noindent D. Carlos López Nozal y Raúl Marticorena Sánchez, profesores del departamento de Ingeniería Civil, área de Lenguajes y Sistemas Informáticos.

\noindent Exponen:

\noindent Que el alumno D. \nombre, con DNI 71308224J, ha realizado el Trabajo final de Máster en Ingeniería Informática titulado Análisis Visual de Revisiones de Código. 
